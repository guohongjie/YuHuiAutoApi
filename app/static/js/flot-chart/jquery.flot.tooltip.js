...
(function ($) {
    ...
    FlotTooltip.prototype.init = function(plot) {
		...
		function plothover(event, pos, item) {
            ...
            if (item) {
                ...
                newTipText ="Failure:"+item["series"]["data"][item["datapoint"][0]-1][1]+";\n Domain:" +item["series"]["data"][item["datapoint"][0]-1][2]+";\n Date:" +  item["series"]["data"][item["datapoint"][0]-1][3];
                }else{
                newTipText ="Success:"+item["series"]["data"][item["datapoint"][0]-1][1]+";\n Domain:" +item["series"]["data"][item["datapoint"][0]-1][2]+";\n Date:" +  item["series"]["data"][item["datapoint"][0]-1][3];
                }
                $tip.html(newTipText);
    ...
    FlotTooltip.prototype.stringFormat = function(content, item) {
        ...
        if( typeof(content) === 'function' ) {
            console.log(item.series.data[item.dataIndex][0]);
